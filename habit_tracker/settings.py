...
# Set settings for JWT Authentication

ACCESS_TOKEN_MINUTES = int(os.getenv('JWT_ACCESS_TOKEN_LIFETIME'))
REFRESH_TOKEN_DAYS = int(os.getenv('JWT_REFRESH_TOKEN_LIFETIME'))
